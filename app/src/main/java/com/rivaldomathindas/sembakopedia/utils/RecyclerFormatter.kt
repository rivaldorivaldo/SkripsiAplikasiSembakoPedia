...
class RecyclerFormatter {
    ...
    class SimpleDividerItemDecoration(context: Context) : RecyclerView.ItemDecoration() {
        private val mDivider: Drawable? = androidx.core.content.ContextCompat.getDrawable(context, com.rivaldomathindas.sembakopedia.R.drawable.simple_recycler_divider)
    ...
    class DoubleDividerItemDecoration(context: Context) : RecyclerView.ItemDecoration() {
        private val mDivider: Drawable? = androidx.core.content.ContextCompat.getDrawable(context, com.rivaldomathindas.sembakopedia.R.drawable.recycler_divider)
