...
class StatsMonthlyFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        monthlyChart.setMaxVisibleValueCount(7)
        ...
        val rightAxis: YAxis = monthlyChart.axisRight
        rightAxis.isEnabled = false
        val legend = monthlyChart.legend
        legend.isEnabled = false

        // add cubic chart
        val xAxisFormatter = DayFormatter(monthlyChart)
        ...
        val leftAxis: YAxis = monthlyChart.axisLeft
        ...
        mv.chartView = monthlyChart
        monthlyChart.marker = mv
    }
}